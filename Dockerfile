...
RUN mkdir -p /go/src/github.com/phorest/rabbit-amazon-forwarder
WORKDIR /go/src/github.com/phorest/rabbit-amazon-forwarder
...
COPY --from=golang-build /go/src/github.com/phorest/rabbit-amazon-forwarder/rabbit-amazon-forwarder /
